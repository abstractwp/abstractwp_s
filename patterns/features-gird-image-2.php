<?php
/**
 * Title: Feature grid image 2
 * Slug: wds/features-grid-image-2
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":78,"sizeSlug":"large","linkDestination":"none"} -->
